          ...
          <Card className="w-full">
            <CardHeader className="space-y-2">
              ...
              <CardDescription className="text-copy-14 text-muted-foreground">
                This Privacy Policy explains how Sykra collects, uses, and shares information when you use the
                Service.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc space-y-2 pl-5 text-copy-14 text-muted-foreground">
                  ...
                  <li>To comply with law or protect the rights, safety, and security of Sykra and users.</li>
                </ul>
              </section>
