          ...
          <Card className="w-full">
            <CardHeader className="space-y-2">
              ...
              <CardDescription className="text-copy-14 text-muted-foreground">
                These Terms of Service (&quot;Terms&quot;) govern your access to and use of Sykra and its related services (the
                &quot;Service&quot;).
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <section className="space-y-2">
                ...
                <p className="text-copy-14 text-muted-foreground">
                  ...
                  Sykra a limited license to host, process, analyze, and display your content solely to provide and
                  improve the Service.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p className="text-copy-14 text-muted-foreground">
                  ...
                  Your use of those services is governed by their terms and policies, and Sykra is not responsible for
              ...
              <section className="space-y-2">
                ...
                <p className="text-copy-14 text-muted-foreground">
                  The Service is provided &quot;as is&quot; and &quot;as available.&quot; To the maximum extent permitted by law, Sykra
              ...
              <section className="space-y-2">
                ...
                <p className="text-copy-14 text-muted-foreground">
                  To the maximum extent permitted by law, Sykra will not be liable for any indirect, incidental,
              ...
              <section className="space-y-2">
                ...
                <p className="text-copy-14 text-muted-foreground">
                  You agree to defend, indemnify, and hold harmless Sykra from and against claims, liabilities,
              ...
              <section className="space-y-2">
                ...
                <p className="text-copy-14 text-muted-foreground">
                  These Terms are governed by the laws of the jurisdiction where Sykra is established, without regard
